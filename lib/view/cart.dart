...
import 'package:ecommerce/view/checkout.dart';
      ...
      body: ListView(
        ...
        children: [
          Container(
            ...
            child: const Center(child: Text("Delivery for FREE until the end of the month")),
          ),
          ListView.separated(
            itemCount: 2,
            shrinkWrap: true,
            ...
            itemBuilder: (context, index) {
              return Container(
                padding: 10.allP,
                decoration:
                    BoxDecoration(color: Constant.white, borderRadius: 10.allBR, boxShadow: const [
                  BoxShadow(
                ...
                child: IntrinsicHeight(
                  child: Row(
                    ...
                    children: [
                      Image.asset(
                        Assets.resourcesImagesImCartP1,
